SM.DefineModule('pxlr/gl/webgl', function (require) {
  ...
  return SM.DefineClass([DomHelpers, {
    ...
    setCameraPerspective() {
      this.perspectiveMatrix = this._makePerspective(45, this.width / this.height, 0.1, 1000.0);
      this.movementMatrix = this._makeMovement();
    ...
    _makePerspective(fovy, aspect, znear, zfar) {
    ...
    _makeFrustum(left, right, bottom, top, znear, zfar) {
