SM.DefineModule('pxlr/gl/webgl', function (require) {
  ...
  return SM.DefineClass([DomHelpers, {
    ...
    createBuffers: function () {
      ...
      var colorWidthStep = 1.0 / width;
      var colorHeightStep = 1.0 / height;
    ...
    drawScene: function () {
      ...
      this.perspectiveMatrix = makePerspective(45, 200.0 / 150.0, 0.1, 200.0);
      ...
      this.mvTranslate([-100.0, -70.0, -200.0]);
